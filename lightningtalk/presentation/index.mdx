...
<Layout>
  <Fill style={{ margin: "auto" }}>
    <Heading size={3}>For example, here is a <Link href="https://dash-gallery.plotly.host/dash-daq-satellite-dashboard/">dashboard of satellite telemetry</Link>.</Heading>
