...
<Layout>
  <Fill style={{ margin: "auto" }}>
    <Heading size={3}>Example, here is a <Link href="https://dash-gallery.plotly.host/dash-daq-satellite-dashboard/">satellite telemetry dashboard</Link>.</Heading>
...
# The result, including loading data from Google BigQuery, is a <Link href="https://julia-gcp-bigquery-n673kvbdna-an.a.run.app/">work in progress</Link>.
## ダッシュボードは、Google BigQueryからのデータの読み込みを含み、進行中の作業です。
